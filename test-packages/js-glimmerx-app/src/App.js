 ...
 * @property {object} Args
 * @property {import('@norith/glint-template').WithBoundArgs<typeof Component<FormattedNameSignature>, 'name'>} Args.title I really can't think of a good description
 */
/**
